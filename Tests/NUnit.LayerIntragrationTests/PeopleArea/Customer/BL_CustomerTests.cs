...
{
    [TestFixture]
    class BlCustomerTests : TestBase
    {
        const string EmailAddy = @"TestCase@addy.net";

        OrderInvoice_BL.People.Customer _e1;
        ...
        public void Dispose()
        {
            var extraRecords = OrderInvoice_BL.People.Customer.GetAllCustomers(GetRepository, true, true);
            foreach (OrderInvoice_BL.People.Customer customer in extraRecords)
            {
                var tempPhoneNumbers = customer.GetPhoneNumbers(true);
                foreach (PhoneNumber phoneNumber in tempPhoneNumbers)
                {
                    _e1.RemovePhoneNumber(phoneNumber);
                }
                var tempSnailMail = customer.GetAllAddresses(true);
        ...
        public void DeletionTest()
        {
            ...
            OrderInvoice_BL.People.User uObj = OrderInvoice_BL.People.User.GetUserById(_e1.UserId, GetRepository);
            Assert.IsTrue(uObj.Deleted);
            OrderInvoice_BL.People.Customer eObj = OrderInvoice_BL.People.Customer.GetCustomerById(_e1.Id, GetRepository);
        ...
        public void GetAllActiveTest()
        {
            ...
            List<OrderInvoice_BL.People.Customer> results =
                OrderInvoice_BL.People.Customer.GetAllCustomers(GetRepository);
        ...
        public void GetAllTest()
        {
            ...
            List<OrderInvoice_BL.People.Customer> results =
                OrderInvoice_BL.People.Customer.GetAllCustomers(GetRepository, true, true);
        ...
        {
            OrderInvoice_BL.People.Customer testObj = new OrderInvoice_BL.People.Customer(GetRepository);
        ...
        public void SetDefaultNumberOnNewCreatedContactTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = new OrderInvoice_BL.People.Customer(GetRepository);
            Assert.Throws<RequiredFieldException>(() => testCustomer.SetDefaultNumber(testObj));
        }
        ...
        public void SetDefaultNumberOnNewCreatedPhoneNumberTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = new OrderInvoice_BL.People.Customer(GetRepository);
            Assert.Throws<ClassDependencyException>(() => testCustomer.SetDefaultNumber(testObj));
        }
        ...
        public void SetDefaultNumberOnDeletedPhoneNumberTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = GetTestCustomer();
            Assert.Throws<ClassDependencyException>(() => testCustomer.SetDefaultNumber(testObj));
        }
        ...
        public void RemovePhoneNumberOnNewCreatedContactTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = new OrderInvoice_BL.People.Customer(GetRepository);
            Assert.Throws<RequiredFieldException>(()=> testCustomer.RemovePhoneNumber(testObj));
        }
        ...
        public void SetDefaultAddressOnNewCreatedContactTest()
        {
            ...
            Assert.Throws<RequiredFieldException>(() => testCustomer.SetDefaultEMailAddress(testAddy));
        }
        ...
        /// </summary>
        [Test]
        public void PermanentRemoveEmailAddress1Test()
        {
            EmailAddress addedAddy = _e1.AddEmailAddress(EmailAddy);
        ...
        public void SetDefaultSnailMailAddressTest()
        {
            SnailMailAddress testObj = new SnailMailAddress(GetRepository)
            {
                ...
                Country = GetOrCreateCountry(CountryName.UnitedStates),
                Zip = "85234",
                Type = GetOrCreateSnailMailType(MailType.Billing)
            };
            testObj.Save();
        ...
        public void SetDefaultSnailMailAddressOnNewCreatedContactTest()
        {
            ...
            Assert.Throws<RequiredFieldException>(() => testCustomer.SetDefaultAddress(testObj));
        }
        ...
        public void SetDefaultSnailMailAddressOnNewCreatedPhoneNumberTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = GetTestCustomer();
            Assert.Throws<ClassDependencyException>(() => testCustomer.SetDefaultAddress(testObj));
        }
        ...
        public void RemoveSnailMailAddressOnNewCreatedContactTest()
        {
            ...
            OrderInvoice_BL.People.Customer testCustomer = new OrderInvoice_BL.People.Customer(GetRepository);
            Assert.Throws<RequiredFieldException>(()=> testCustomer.RemoveAddress(testObj));
        }
