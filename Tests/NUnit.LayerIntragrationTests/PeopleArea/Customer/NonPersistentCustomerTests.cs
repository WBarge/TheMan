...
{
    [TestFixture]
    class NonPersistentCustomerTests : TestBase
    {
        OrderInvoice_BL.People.Customer _customer;
        ...
        {
            _customer = new OrderInvoice_BL.People.Customer(GetRepository);
            _user = _customer;
            _contact = _user;
        }
        ...
        {
            Assert.IsTrue(_customer.IsNotEmpty());
        ...
        {
            Assert.AreEqual(_customer.Id, DefaultValues.DefaultInt);
        ...
        {
            Assert.IsFalse(_customer.Deleted);
        ...
        {
            Assert.AreEqual(_customer.Number, 0);
        }
    }
}
