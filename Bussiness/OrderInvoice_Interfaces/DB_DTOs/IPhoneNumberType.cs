...
// ***********************************************************************
// <copyright file="IPhoneNumberType.cs" company="OrderInvoice_Interfaces">
...
namespace OrderInvoice_Interfaces.DB_DTOs
{
    ...
    public interface IPhoneNumberType 
    {
        ...
        /// <summary>
        /// Gets or sets the phone numbertype.
        /// </summary>
        /// <value>The phone numbertype.</value>
        string PhoneNumbertype { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="IPhoneNumberType"/> is deleted.
        /// </summary>
